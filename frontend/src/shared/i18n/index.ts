  ...
  "zh-CN": {
    translation: {
      ...
      accountCredential: {
        ...
        botFlag: "风控标记",
        botFlagEmpty: "-",
        botFlagTooltip: "JWT bot_flag_source",
        botFlagMarked: "已标记",
        botFlagUnmarked: "未标记",
      },
      common: {
      ...
      accounts: {
        ...
        quotaUsagePercent: "额度已用 {{percent}}%",
        quotaUsageUnknown: "额度未同步",
        quotaUsageTokensTooltip: "已使用 {{used}} / 估计总额度 {{limit}} tokens",
        quotaUsageCreditsTooltip: "已使用 {{used}} / 总额度 {{limit}} credits",
        quotaUsageRequestsTooltip: "已使用 {{used}} / 总额度 {{limit}} 次",
        quotaUsagePercentTooltip: "已使用 {{used}}% / 100%",
        ...
        statusActive: "正常",
        botRisk: "风控",
        botRiskTooltip: "上游风控标记。可能影响视频生成能力与其他权限",
        ...
        removeBotFlagged: "移除风控账号",
        removeBotFlaggedTitle: "移除风控账号？",
        removeBotFlaggedDescription: "将移除 {{marked}} / {{total}} 个 Grok Build 账号，此操作无法撤销。",
        removeBotFlaggedNone: "当前没有风控账号。",
        removeBotFlaggedLoading: "正在统计风控账号…",
        botFlaggedRemoved: "已移除 {{count}} 个风控账号",
        cleanupBotFlagged: "风控账号",
        cleanupBotFlaggedCount: "将移除 {{marked}} / {{total}} 个账号",
        cleanupAction: "账号清理",
        cleanupTitle: "清理 {{provider}} 账号",
        cleanupDescription: "按状态删除当前渠道的账号及其额度数据。Grok Build 还可清理风控账号。正常可用账号默认不会被处理。此操作无法撤销。",
  ...
  en: {
    translation: {
      ...
      accountCredential: {
        ...
        botFlagEmpty: "-",
        botFlagTooltip: "JWT bot_flag_source",
        botFlagMarked: "Marked",
        botFlagUnmarked: "Unmarked",
      },
